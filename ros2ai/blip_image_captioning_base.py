...
class ros2aiNode(Node):
    ...
    def __init__(self):
        ...
        super().__init__('blip_image_captioning_base')
    ...
    def listener_callback(self, msg):
        inputs = self.processor(self.bridge.imgmsg_to_cv2(msg, desired_encoding='bgr8'), "a photography of", return_tensors="pt").to("cuda", torch.float16)
